...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class FirebaseUiLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>firebase.ui</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class RetrofitLibraryAccessors extends SubDependencyFactory {
        ...
        public Provider<MinimalExternalModuleDependency> getGsonConverter() {
            return create("retrofit.gsonConverter");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>mapsCompose</b> with value <b>4.2.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class FirebaseVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>firebase</b> with value <b>33.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>firebase.ui</b> with value <b>7.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getUi() { return getVersion("firebase.ui"); }
    ...
    public static class GmsVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>gms.services</b> with value <b>4.4.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getServices() { return getVersion("gms.services"); }
    ...
    public static class GmsPluginAccessors extends PluginFactory {
         ...
         * with version reference <b>gms.services</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
